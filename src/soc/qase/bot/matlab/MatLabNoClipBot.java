 ...
 *	as any Java object. MatLabNoClipBot additionally allows the agent to
 *	'clip' to a specific point on the map, as long as the '+set cheats 1'
 *	option is enabled on the Quake 2 server.*/
/*-------------------------------------------------------------------*/
